...
They say it helps to do a so called A/B comparison with a reference. I.e. have a reference track, yours or someone else's, that you want your track to sound comparable with. And it's indeed a very useful method to quickly see how your mix sounds next to some reference one.
